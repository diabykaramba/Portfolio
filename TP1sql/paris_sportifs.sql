...
--
-- Hôte : localhost
-- Généré le : lun. 17 nov. 2025 à 15:58
...
(10, 'PSG', 'OM', '2025-11-22 21:00:00', 1),
(20, 'Lakers', 'Bulls', '2025-11-18 03:00:00', 2),
(30, 'Nadal', 'Federer', '2025-11-29 16:00:00', 3);
...
ALTER TABLE `matchs`
  ...
  ADD KEY `sport` (`id_sport`) USING BTREE;
...
ALTER TABLE `pari`
  ...
  ADD KEY `matchs` (`id_match`),
  ADD KEY `typepari` (`id_typepari`);
...
--
ALTER TABLE `matchs`
  MODIFY `id_match` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `pari`
  ADD CONSTRAINT `pari_ibfk_1` FOREIGN KEY (`id_match`) REFERENCES `matchs` (`id_match`),
  ADD CONSTRAINT `pari_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `utilisateur` (`id_user`),
