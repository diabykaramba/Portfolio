...
// Requête SQL pour avoir le nombre total de formateurs
$sql = "SELECT COUNT(*) AS total_formateurs FROM formateurs;";
...
<br>
<h2>Nombre total de formateurs</h2>
...
<table>
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>";
            echo "<td>".$row['total_formateurs']."</td>";
            echo "</tr>";
        }
    } else {
