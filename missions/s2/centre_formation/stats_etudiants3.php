...
if (mysqli_query($conn, $sql_ins)) {
        // Redirection pour éviter de renvoyer le formulaire si on rafraîchit la page
        header("Location: stats_etudiants3.php");
        exit();
    }
}

// Requête pour l'affichage de la liste des étudiants
$result = mysqli_query($conn, "SELECT * FROM etudiants ORDER BY id_etudiant DESC");
?>
