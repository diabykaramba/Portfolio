...
<?php
	...
	$requete="SELECT * FROM eleves WHERE num_enseignant='$d';";
...
<form action="update.php" method="POST">
	<label>Numéro:</label>
    <input type="text" name="num_enseignant" value="<?php echo($enreg['num_enseignant']); ?>" readonly>
	<br>
	<label>Nom:</label>
...
<?php
		...
		echo 'Veuillez entrer un numéro enseignant'.'<br>';
		echo '<input type="text" name="num_enseignant">'.'<br>';
...
?>
	...
	echo '<input type="text" name ="num" value="'.$enreg['num_enseignant'].'">';
